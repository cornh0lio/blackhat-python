...
def main():
    ...
    # setup remote listening parameters
    remote_host = sys.argv[3]
    remote_port = int(sys.argv[4])

    # this tells our proxy to connect and receive data first
...
def proxy_handler(client_socket,remote_host,remote_port,receive_first):
    ...
    # receive data first from the remote_host if setted in receive_first flag
    if receive_first:
...
# http://code.activestate.com/recipves/142812-hex-dumper/
...
def receive_from(connection):
    ...
    # We set a 2 second timeoute; depending on your target, this may need to be adjusted
